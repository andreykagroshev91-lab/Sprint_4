...
public class FirefoxOrderTest extends BaseTest {
    ...
    public FirefoxOrderTest(String buttonType, String name, String surname, String address, String phone) {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
                {"top", "Дубина", "Кабана", "Улица дырявая", "89999999999"},
                {"bottom", "Кабанчик", "Бежит", "Пятка 1905", "+78888888888"}
        });
    }
